...
train_file = r'E:\ai_contest\ccks\mytheta\myRepo\theta-master-0826\theta\examples\CCKS2021\data\ccks_task1_train.txt'
eval_file = r'E:\ai_contest\ccks\mytheta\myRepo\theta-master-0826\theta\examples\CCKS2021\data\ccks_task1_eval_data.txt'
